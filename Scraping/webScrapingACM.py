...
names_l1 = ['Steven J. Benson', 'Prasoon Goyal', 'Michael O. Duff', 'Hui Tong', 'Justin B. Kinney', 
            ...
            'Jacky Shunjie Zhen', 'David Degras', 'Mathias Unberath', 'Shebuti Rayana', 'Zenon W. Pylyshyn', 'Michael H R Stanley', 'Irene Aldridge', 'Thomas M. Walski', 'Chahira Lhioui', 'Barak Libai', 'Michal Kempka', 'Yvonne Choquet-Bruhat', 'Jillian H. Fecteau', 'Craig R. Hullett', 'Andrzej Pelc', 'Sabine Glesner', 'Shengcai Liao', 'Marie Csete', 'David Knowles', 'Piyush Gupta', 'Heiko Dietze', 'Kerstin Hammernik', 'Artem Grotov', 'Luc Berthouze', 'John Miles Smith', 'Brian Michael Adams', 'Michele Benzi', 'Ruiji Fu', 'Hongliang Jin', 'Eric A. Wan', 'Ponnada A. Narayana', 'Craige Roberts', 'Mel Slater', 'Jiahao Chen', 'Susan J. Hespos', 'Bo Hedén', 'Guoxin Su', 'Julian Straub', 'Gerhard Paass', 'Makbule Gulcin Ozsoy', 'Jingchen Liu', 'Probal Sengupta', 'Michael D. Wagner', 'Gintare Karolina Dziugaite', 'Emmanuel J. Cand', 'Seokju Lee', 'Oren Tsur', 'Alexander Schick', 'Eric L. Miller', 'Unsang Park', 'Jianshu Weng', 'Michael Wibral', 'Yufei Li', 'Çağatay Demiralp', 'Alfonso Gerevini', 'Seif El-Din Bairakdar', 'Lina Merchan', 'Alberto Fernández', 'A.O. Nicholls', 'Payman Mohassel', 'M. V. Garzelli', 'Geoffrey Sampson', 'Ali Shiravi', 'Victor Garcia', 'Nick C. Fox', 'Wen Zhang', 'Nikolaus Bee', 'Felix von Reischach', 'Peng Wang', 'Henrik Skibbe', 'Zhiyuan Chen', 'Yanan Fan', 'Xianghua Ying', 'Augustinos I. Dimitras', 'Kevin T. Kelly', 'Jasna Maver', 'Samah Jamal Fodeh', 'Ruth S. DeFries', 'Marius Lindauer', 'Hayman', 'T. W. Anderson', 'Ian Hacking', 'Francisco Fernández-Navarro', 'János Komlós', 'David McSherry', 'Jean-Rémi King', 'Mauricio Santillana', 'Zhiqiang Tan', 'Di Zhao', 'Phillip D. Summers', 'Siddhartha Saha', 'Layla Oesper', 'Peyman Milanfar', 'Piotr Bojanowski', 'Joachim Lambek', 'Andreas Weber', 'Kyle A. Beauchamp', 'Mikhail Prokopenko', 'Nikolas List', 'Alan R. Aronson', 'Jost-Hinrich Eschenburg', 'R. Duncan Luce', 'Robert Spence', 'Chris Grier', 'Michael Schwarz', 'Amir H. Banihashemi', 'Dorthe Meyer', 'Qing Li', 'Anika Gross', 'Gwo-Fong Lin', 'Wei He', 'Xu He', 'Abhyuday N Jagannatha', 'Themistoklis Charalambous', 'Sylvia Glaßer', 'Eleanor Wong', 'Tianyi Jiang', 'Chee-Seng. Chow', 'Emmanouil Benetos', 'Peter List', 'Francisco Javier Díez', 'Krishnakumar Balasubramanian', 'Weiwei Sun', 'Pitu B. Mirchandani', 'Kirill Neklyudov', 'George Gargov', 'E. Llobet', 'Marco F. Huber', 'Yeong-Taeg Kim', 'James L. Peterson', 'Feng Zhao', 'Stefano Palminteri', 'Roger Ratcliff', 'Piero Fariselli', 'S. Boukharouba', 'Ying Wen', 'Mohammad Yaqub', 'Enrique Alfonseca', 'Haim H. Permuter', 'Si Wu', 'Keith Ball', 'Steve Chien', 'Arjun Jain', 'Tomasz Piotr Kucner', 'Pawan Nunthanid', 'SueYeon Chung', 'Georgios Theocharous', 'Vera Kurkova', 'René Ranftl', 'Julien Cornebise', 'Richard L. Bankert', 'James Theiler', 'Shing-Chow Chan', 'Karen Coyle', 'David Finch', 'Jorma Laaksonen', 'Alexander Kotov', 'Thomas Pfeil', 'Sachithra Hemachandra', 'David C. Burr', 'Kleomenis Katevas', 'Brent Wenerstrom', 'Ger Koole', 'Sonya Cates', 'Sanjeev Arora', 'Kui Jia', 'Nicolas Sidère', 'Reinhard Selten', 'Hendrik P. Lopuhaä', 'Nick Yee', 'Carl E. Landwehr', 'Guido Governatori', 'Luc Berthouze', 'Vincenzo Nicosia', 'Zhuoran Yang', 'Valentina Zanardi', 'Loris Bazzani', 'E. Solak', 'Mustapha Bouhtou', 'Anna Dreber', 'Narendra Ahuja', 'Michel Dumontier', 'Chong Yaw Wee', 'D. Guest', 'Giorgio Tomasi', 'Jiawen Chen', 'Gordon Wetzstein', 'A. Hannachi', 'Anjuli Kannan', 'Mark A. Przybocki', 'Samy Bengio', 'Gerard A. Silvestri', 'Polina Mamoshina', 'Alexandru T. Balaban', 'Andrew S. Gordon', 'Georges Le Goualher', 'Raciel Yera Toledo', 'Esca Tutorial Day', 'Joseph K. Bradley', 'Manchester Syntax', 'Rui Wang', 'Penelope Eckert', 'Tuncer C. Aysal', 'Abdelkader Mokkadem', 'Michael P. Wellman', 'Xiangbo Feng', 'Alberto Camacho', 'Peter Buchholz', 'Vladimir Filkov', 'Dov Katz', 'Toby H. W. Lam', 'Lachlan L. H. Andrew', 'Ramazan Gençay', 'Chul Min Lee', 'Souneil Park', 'Harold P. Benson', 'Rasmus Kyng', 'Thomas Berg', 'Mabkhout M. Al-Dousari', 'Fu Jie Huang', 'Marc Jeannerod', 'Ali Pesaranghader', 'N. Arumainayagam', 'Ou Tan', 'Nachiketa Sahoo', 'Frédéric Ferraty', 'Jinwook Seo', 'Bart Bogaerts', 'Ernst Hairer', 'Mirjam Minor', 'Antonio Monroy', 'Jue Wang', 'Rohini K. Srihari', 'Congzheng Song', 'Cooper Bills', 'Xiao-Hu Yu', 'An Sing Chen', 'Ana C. Huamán Quispe', 'Babak Rahbarinia', 'Bruno Bouzy', 'Carlos A. Leon', 'Mohamed Ahmed', 'Minghui Liao', 'Amirreza Shaban', 'Bin Yang', 'Thomas D. Ndousse', 'Michael Morak', 'Ahmad El Sallab', 'Wei-Chen Cheng', 'Ji Li', 'Anup Basu', 'S. S. Ravi', 'Michael A. Erdmann', 'A. Lapedes', 'Arash Mokhber', 'Connelly Barnes', 'T. Charles Clancy', 'Kevin Bleakley', 'Hao Quan', 'Emilie Kaufmann', 'Zeju Li', 'Rul Yamaguchi', 'Trinh Minh Tri Do', 'S. Esakkirajan', 'John T. Rickard', 'Olivier Catoni', 'Xavier Dutreilh', 'Ujjwal Maulik', 'Gert Storms', 'Stig Kjær Andersen', 'Jan P. H. van Santen', 'Gábor Melis', 'Michael Wooldridge', 'Jean van Heijenoort', 'Blai Bonet', 'Kevin Swersky', 'Jose San Pedro', 'Ohlsson Stellan', 'Xu Han', 'Piyasak Jeatrakul', 'Gultekin Ozsoyoglu', 'Aron Monszpart', 'C. K. Chow', 'Arnav Bhavsar', 'Ping Xuan', 'Robert R. Prechter', 'Daniel Tunkelang', 'Jacob Devlin', 'Ernesto A. B. F. Lima', 'Ben Tordoff', 'Markus Maurer', 'Sandra Fortini', 'Pedro Mendes', 'Gerald M. Reaven', 'Zhuoliang Kang', 'Biao Zhang', 'Yue Cao', 'Dario Figueira', 'Christian Meilicke', 'Mo Chen', 'Grant McKenzie', 'Ralf Der', 'Kristina Lerman', 'Xiaochun Cao', 'Matthias Strobbe', 'Hans Nyquist', 'Scott L. Painter', 'G. Sithole', 'Yoshinobu Kawahara', 'Ozan Sener', 'Junshan Zhang', 'Daofu Liu', 'Dirk Kraft', 'Xiang Ma', 'Chris Edwards', 'Jerry E. Pratt', 'Michael F. Barnsley', 'Roger A. Horn', 'S. James Press', 'Ari Holtzman', 'Leszek Pacholski', 'Andrea L. Bertozzi', 'George B. Dantzig', 'Philip J. Fleming', 'Ibrahim Mohamed Hassan Saleh', 'Raymond Phan', 'Ciprian Chelba', 'Sylvain Veilleux', 'Ron J. Weiss', 'Joydeep Ghosh', 'Katherine P. Liao', 'Minjie Wu', 'Goran Gogic', 'Lucas Fidon', 'Yuanjun Gao', 'Matteo Masotti', 'Joshua W. K. Ho', 'Kjetil Moløkken', 'Gregory A. Bryant', 'Stan Z. Li', 'Michael Hoey', 'Matthew J. C. Crump', 'Darrin C. Edwards', 'Ju-Chiang Wang', 'Bo Sun', 'Josip Krapac', 'Chenguang Wang', 'Mário S. Alvim', 'Min Zhao', 'Bruno Nicenboim', 'Lars Bretzner', 'Abhishek Bhattacharya', 'Nahla Ben Amor', 'Akshay Asthana', 'Pietro Ducange', 'Xiaorui Ma', 'Samaneh Moghaddam', 'Soonmin Bae', 'Guy Pierra', 'Jessica D. Tenenbaum', 'Luo-Luo Jiang', 'Beata Jarosiewicz', 'Anton Maximilian Schäfer', 'Samanwoy Ghosh-Dastidar', 'Rudolf Mayer', 'Sariel Har-Peled', 'S. Corrsin', 'Robert Oliver Castle', 'Jim Kleban', 'Gavin E. Crooks', 'Alan J. Laub', 'Paolo Raiteri', 'Kwang Won Sok', 'Ali Ghadirzadeh', 'Andrew J. Connolly', 'George E. Billman', 'Zexuan Zhu', 'Takuya Narihira', 'Samuel R. Buss', 'Pascal Bérard', 'Liping Jing', 'Prakhar Biyani', 'Sam Alxatib', 'William R. Murray', 'D. G. Horvitz', 'Lucia Wittner', 'Olle Häggström', 'R. Douc', 'Shaojun Wang']
list_authors = names_l1[0:1]
start = time.time()
df = construct_csv(list_authors)
end = time.time()
